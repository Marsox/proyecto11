...
<body>
	...
	<div class="container-fluid jumbotron">
		<header>
			<h2 class="display-4 text-center">Ejercicio 7</h2>
		</header>

		<div class="container-text">
			<p class="lead">Crear un programa que pida un número real y muestre la tabla de multiplicar correspondiente a dicho número perfectamente formateada y con una precisión de dos dígitos.</p>
			<h4>Solución</h4>
			<?php 
